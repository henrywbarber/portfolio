	...
	return (
		<Container className="about-section content-section">
			...
			<Row className="text-center" style={{ paddingTop: "1rem" }}>
				<Col>
					<p>
						I'm a Junior Software Engineer with a passion for creative problem
						solving and continuous learning. When I'm not tackling code, you'll
						likely find me biking with friends, exploring nature trails, or
						crafting new music playlists. I'm always looking to expand my skills
						and make an impact through everyday technology.
					</p>
				</Col>
			</Row>

			<Row className="skills-section justify-content-center">
				{[CPPlogo, Javalogo, Pythonlogo, SQLlogo, VSlogo, Jiralogo].map(
					(icon, index) => (
						<Col
							xs={6}
							sm={4}
